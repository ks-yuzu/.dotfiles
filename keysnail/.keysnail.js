...
key.setCaretKey("C-f", function (ev) { ev.target.ksMarked ? goDoCommand("cmd_selectCharNext") : command.nextChar(ev); }, 'キャレットを一文字右へ移動', false);
key.setCaretKey("C-b", function (ev) { ev.target.ksMarked ? goDoCommand("cmd_selectCharPrevious") : command.previousChar(ev); }, 'キャレットを一文字左へ移動', false);
key.setCaretKey("M-f", function (ev) { ev.target.ksMarked ? goDoCommand("cmd_selectWordNext") : command.forwardWord(ev); }, 'キャレットを一単語右へ移動', false);
key.setCaretKey("M-b", function (ev) { ev.target.ksMarked ? goDoCommand("cmd_selectWordPrevious") : command.backwardWord(ev); }, 'キャレットを一単語左へ移動', false);
key.setCaretKey("C-n", function (ev) { ev.target.ksMarked ? goDoCommand("cmd_selectLineNext") : command.nextLine(ev); }, 'キャレットを一行下へ', false);
key.setCaretKey("C-p", function (ev) { ev.target.ksMarked ? goDoCommand("cmd_selectLinePrevious") : command.previousLine(ev); }, 'キャレットを一行上へ', false);
key.setCaretKey("C-v", function (ev) { ev.target.ksMarked ? goDoCommand("cmd_selectPageNext") : command.pageDown(ev); }, 'キャレットを一画面分下へ', false);
key.setCaretKey("M-v", function (ev) { ev.target.ksMarked ? goDoCommand("cmd_selectPagePrevious") : command.pageUp(ev); }, 'キャレットを一画面分上へ', false);
key.setCaretKey("C-a", function (ev) { ev.target.ksMarked ? goDoCommand("cmd_selectBeginLine") : command.beginLine(ev); }, 'キャレットを行頭へ移動', false);
